  ...
  >
    ...
    <div class="mb-3">
      <h3 class="text-lg font-medium text-gray-900 dark:text-white">
        End your search with a
        <a
          @click="openUrl('https://duckduckgo.com/bangs')"
          class="text-blue-500 dark:text-blue-400 hover:underline"
          >bang!</a
        >
      </h3>
      <p class="text-sm text-gray-600 dark:text-gray-400">
        Add <span class="font-mono bg-gray-100 dark:bg-gray-700 px-1 rounded">!</span> to send your
        search to a specific website.
      </p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
      ...
      >
        <span class="font-mono font-bold text-blue-600 dark:text-blue-400 mr-2"
          >!{{ bang.bang }}</span
        >
